...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC07_Withoutcallforwardingnumber.feature",
        ...
        , monochrome = true,
        tags = "@Withoutcallforwardingnumber"
)

public class TC07_Withoutcallforwardingnumber_TestRunner extends AbstractTestNGCucumberTests {
    @Override
