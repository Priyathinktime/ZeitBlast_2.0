...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC23_NoMessageShuffleValidation.feature",
        ...
        , monochrome = true,
        tags = "@responsenoshufflevalidation"
)

public class TC23_NoMessageShuffleValidation_TestRunner extends AbstractTestNGCucumberTests {
    @Override
