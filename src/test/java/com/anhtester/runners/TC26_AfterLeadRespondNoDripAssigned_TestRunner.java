...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC26_AfterLeadRespondNoDripAssigned.feature",
        ...
        , monochrome = true,
        tags = "@leadrespondtodripmessage"
)

public class TC26_AfterLeadRespondNoDripAssigned_TestRunner extends AbstractTestNGCucumberTests {
    @Override
