...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC22_RunFollowUpCampaign.feature",
        ...
        , monochrome = true,
        tags = "@RunFollowUpCampaign"
)

public class TC22_RunFollowUpCampaign_TestRunner extends AbstractTestNGCucumberTests {
    @Override
