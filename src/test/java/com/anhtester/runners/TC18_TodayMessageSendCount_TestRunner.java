...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC18_TodayMessageSendCount.feature",
        ...
        , monochrome = true,
        tags = "@todaymessagesendcount"
)

public class TC18_TodayMessageSendCount_TestRunner extends AbstractTestNGCucumberTests {
    @Override
