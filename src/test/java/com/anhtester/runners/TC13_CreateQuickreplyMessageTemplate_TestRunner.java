...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC13_CreateQuickreplyMessageTemplate.feature",
        ...
        , monochrome = true,
        tags = "@createquickreplytemplate"
)

public class TC13_CreateQuickreplyMessageTemplate_TestRunner extends AbstractTestNGCucumberTests {
    @Override
