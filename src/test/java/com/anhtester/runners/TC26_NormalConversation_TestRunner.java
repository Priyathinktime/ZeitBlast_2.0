...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC26_NormalConversation.feature",
        ...
        , monochrome = true,
        tags = "@normalconversation"
)

public class TC26_NormalConversation_TestRunner extends AbstractTestNGCucumberTests {
    @Override
