...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC21_CreateFollowUpCampaign.feature",
        ...
        , monochrome = true,
        tags = "@CreateFollowUpCampaign"
)

public class TC21_CreateFollowUpCampaign_TestRunner extends AbstractTestNGCucumberTests {
    @Override
