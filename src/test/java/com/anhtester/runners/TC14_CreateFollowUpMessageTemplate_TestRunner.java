...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC14_CreateFollowUpMessageTemplate.feature",
        ...
        , monochrome = true,
        tags = "@createfollowupmessagetemplate"
)

public class TC14_CreateFollowUpMessageTemplate_TestRunner extends AbstractTestNGCucumberTests {
    @Override
