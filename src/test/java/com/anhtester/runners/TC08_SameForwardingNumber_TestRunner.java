...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC08_SameForwardingNumber.feature",
        ...
        , monochrome = true,
        tags = "@SameCallForwardingNumber"
)

public class TC08_SameForwardingNumber_TestRunner extends AbstractTestNGCucumberTests {
    @Override
