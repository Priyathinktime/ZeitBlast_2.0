...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC15_InboxPagevalidation.feature",
        ...
        , monochrome = true,
        tags = "@inboxpagevalidation"
)

public class TC15_InboxPagevalidation_TestRunner extends AbstractTestNGCucumberTests {
    @Override
