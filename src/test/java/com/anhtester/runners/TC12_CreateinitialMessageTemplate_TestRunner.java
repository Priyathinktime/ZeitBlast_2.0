...
@Test
@CucumberOptions(
        features = "src/test/resources/features/TC12_CreateinitialMessageTemplate.feature",
        ...
        , monochrome = true,
        tags = "@createintialmessagetemplate"
)

public class TC12_CreateinitialMessageTemplate_TestRunner extends AbstractTestNGCucumberTests {
    @Override
