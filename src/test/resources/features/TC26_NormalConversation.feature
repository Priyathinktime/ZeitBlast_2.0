...
Feature: TC_26 If lead response having normal converstation then drip status should not moved
...
Scenario: 12 Send quick message for single lead
 Given The user logs in the Zeitblast application with "super admin" credentials
  When The User should be able to navigate the Inbox page
...
Scenario: 14 Validate the drip should not be moved after normal conversation
 Given The user logs in the Zeitblast application with "super admin" credentials
  When The User should be able to navigate the Inbox page
