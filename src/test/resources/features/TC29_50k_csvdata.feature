...
@fileupload
@entiretest
Feature: TC_04 Import .CSV File of 50 K Prospect 
...
Scenario: 03 To upload an 50K CSV data in the Direct Import Page
    ...
    And The user upload the excel file "Testdata50.csv" in the import file field
